        ...
        $("#addAnswer").click(function(){
            ...
            <div class="row mt-2 answers">
              <input type="radio" name="is_correct" class="is_correct">
                <div class="col">
                    <input type="text" class="w-100" name="answers[]" placeholder="Enter Answers" required>
                </div>  
        ...
        $("#addEditAnswer").click(function(){
            ...
            <div class="row mt-2 editAnswers">
              <input type="radio" name="is_correct" class="edit_is_correct">
                <div class="col">
                    <input type="text" class="w-100" name="new_answers[]" placeholder="Enter Answers" required>
                </div>  
                <button class="btn btn-danger removeButton">Remove</button>
            </div>
            `;
                ...
                <div class="row mt-2 editAnswers">
                  <input type="radio" name="is_correct" class="edit_is_correct" `+checked+`>
                    <div class="col">
                        ...
                        placeholder="Enter Answers" value="`+qna['answers'][i]['answer']+`" required>
                    </div>  
