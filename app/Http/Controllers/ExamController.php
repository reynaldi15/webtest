    ...
    public function loadExamDashboard($id){
        ...
        if(count($qnaExam)>0){
            ...
            if($attemptCount>=$qnaExam[0]['attempt']){
                return view('student.exam-dashboard',['success'=>false,'msg'=>'Your exam attemption has been complete','exam'=>$qnaExam]);
                ...
                return view('student.exam-dashboard',['success'=>false,'msg'=>'This Exam will has been expaired'.$qnaExam[0]['date'],'exam'=>$qnaExam]);
            }
        }else{
            return view('404');
        }
